...
```bash
"$AWB_CMD" video-fee --modelGroupCode <g> --prompt "雨夜街头，人物缓慢走向镜头，电影感" --quality 720 --generatedTime 5 --ratio 16:9 -f json
...
```bash
"$AWB_CMD" video-fee --modelGroupCode <g> --frameFile ./frame.webp --tailFrameFile ./tail.webp --quality 720 --generatedTime 5 --ratio 16:9 -f json
...
```bash
"$AWB_CMD" video-fee --modelGroupCode <g> --prompt "@角色A 在雨夜奔跑" --refImageFiles "角色A=./char.webp" --quality 720 --generatedTime 5 --ratio 16:9 -f json
...
```bash
"$AWB_CMD" video-fee --modelGroupCode <g> --storyboardPrompts "镜头1：城市远景||镜头2：人物走近镜头" --quality 720 --generatedTime 5 --ratio 16:9 -f json
...
- 简单预算优先 `video-fee`，多参考或故事板要确认结构时再 `dryRun`
